...
public class OwnerLoginHandler : IRequestHandler<OwnerLoginModelRequest, LoginResponse>
{
    private readonly IBeatSportsDbContext _beatSportsDbContext;
    private readonly IIdentityService _identityService;

    public OwnerLoginHandler(IBeatSportsDbContext beatSportsDbContext, IIdentityService identityService)
    {
        _beatSportsDbContext = beatSportsDbContext;
        _identityService = identityService;
    }

    public async Task<LoginResponse> Handle(OwnerLoginModelRequest request, CancellationToken cancellationToken)
    {
