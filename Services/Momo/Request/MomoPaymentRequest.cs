...
using Utils.Helpers;
using Services.Momo.Response;

namespace Services.Momo.Request;
public class MomoPaymentRequest
{
    public MomoPaymentRequest(string partnerCode, string requestId,
    ...
    public (bool, string?) GetLink(string paymentUrl)
    {
        ...
        if (createPaymentLinkRes.IsSuccessStatusCode)
        {
            ...
            var responseData = JsonConvert
                .DeserializeObject<MomoPaymentCreateLinkResponse>(responseContent);
