...
public class CreateZalopayPayRequest
{
    public CreateZalopayPayRequest(int appId, string appUser, long appTime,
            long amount, string appTransId, string bankCode, string description, string embedData, string items/*, string callbackUrl*/)
    {
        AppId = appId;
        AppUser = appUser;
        AppTime = appTime;
    ...
    public Dictionary<string, string> GetContent()
    {
        ...
        keyValuePairs.Add("embeddata", EmbedData);
        keyValuePairs.Add("item",Items);
